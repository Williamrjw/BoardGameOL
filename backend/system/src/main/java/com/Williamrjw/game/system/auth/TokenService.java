...
import com.Williamrjw.game.common.constants.CacheConstants;
import com.Williamrjw.game.common.constants.Constants;
import com.Williamrjw.game.common.user.LoginUser;
import com.Williamrjw.game.common.utils.RedisCache;
import com.Williamrjw.game.common.utils.ServletUtils;
import com.Williamrjw.game.common.utils.ip.AddressUtils;
import com.Williamrjw.game.common.utils.ip.IpUtils;
...
public class TokenService
{
    ...
    public String createToken(LoginUser loginUser,String ssoToken){
    ...
    public void refreshToken(LoginUser loginUser)
    {
        ...
        loginUser.setExpireTime(loginUser.getLoginTime() + properties.getExpireTime() * MILLIS_MINUTE);
        // 根据uuid将loginUser缓存
        String userKey = getTokenKey(loginUser.getToken());
        redisCache.setCacheObject(userKey, loginUser, properties.getExpireTime(), TimeUnit.MINUTES);
    }
    ...
    private String getToken(HttpServletRequest request)
    {
        ...
        if (cookies != null) {
            for (Cookie cookie : cookies) {
                if (properties.getKey().equals(cookie.getName())) {
